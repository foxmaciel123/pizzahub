...
import { MenuSquare, ShieldCheck, Sparkles, CheckCircle2 } from 'lucide-react'
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800/80 pb-5">
          <div className="space-y-1">
            <div className="flex items-center gap-2 text-xs text-slate-400">
              ...
              <span>/</span>
              <span className="text-orange-400 font-medium">Gestão de Cardápio Próprio</span>
            </div>
            <h1 className="text-2xl font-bold text-white tracking-tight flex items-center gap-2.5">
              <MenuSquare className="w-6 h-6 text-orange-500 shrink-0" />
              <span>Gestão de Cardápio Próprio</span>
            </h1>
            <p className="text-xs text-slate-400 max-w-2xl leading-relaxed">
              Controle de categorias, pizzas salgadas, doces, bebidas, bordas, adicionais e preços do canal próprio.
            </p>
          </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            <div key="0" className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-all space-y-2">
              ...
              <p className="text-[11px] text-slate-400 leading-relaxed">Criação e edição em massa de tamanhos, sabores e adicionais do cardápio.
              </p>
            </div>
            <div key="1" className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-all space-y-2">
              <div className="text-xs font-bold text-white flex items-center gap-1.5">
                ...
                <span>Pausa Rápida de Sabores</span>
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">Pausar instantaneamente pizzas ou ingredientes que esgotaram no dia.
              </p>
            </div>
            <div key="2" className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-all space-y-2">
              <div className="text-xs font-bold text-white flex items-center gap-1.5">
                ...
                <span>Sincronização com WhatsApp e Site</span>
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">Atualizações no cardápio refletem imediatamente no catálogo do WhatsApp e na /loja.
              </p>
            </div>
          </div>
        </div>
