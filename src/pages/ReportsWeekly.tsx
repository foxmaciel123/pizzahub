...
import { TrendingUp, ShieldCheck, Sparkles, CheckCircle2 } from 'lucide-react'
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800/80 pb-5">
          <div className="space-y-1">
            <div className="flex items-center gap-2 text-xs text-slate-400">
              ...
              <span>/</span>
              <span className="text-orange-400 font-medium">Relatório Semanal com Insights da IA</span>
            </div>
            <h1 className="text-2xl font-bold text-white tracking-tight flex items-center gap-2.5">
              <TrendingUp className="w-6 h-6 text-orange-500 shrink-0" />
              <span>Relatório Semanal com Insights da IA</span>
            </h1>
            <p className="text-xs text-slate-400 max-w-2xl leading-relaxed">
              Análise profunda de desempenho dos últimos 7 dias com recomendações estratégicas da inteligência artificial.
            </p>
          </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            <div key="0" className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-all space-y-2">
              ...
              <p className="text-[11px] text-slate-400 leading-relaxed">Mapa de calor de vendas identificando gargalos e momentos de maior faturamento.
              </p>
            </div>
            <div key="1" className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-all space-y-2">
              <div className="text-xs font-bold text-white flex items-center gap-1.5">
                ...
                <span>Insights Operacionais da IA</span>
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">Sugestões de compras preventivas, promoções em dias fracos e ajustes de cardápio.
              </p>
            </div>
            <div key="2" className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-all space-y-2">
              <div className="text-xs font-bold text-white flex items-center gap-1.5">
                ...
                <span>Evolução de Retenção</span>
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">Taxa de recompra de clientes que migraram do iFood para o WhatsApp/site próprio.
              </p>
            </div>
          </div>
        </div>
