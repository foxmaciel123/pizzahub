  ...
  const pageContent = (
    <div className="p-6 sm:p-8 max-w-6xl mx-auto space-y-6">
      <div className="border-b border-slate-800 pb-5">
        <h1 className="text-2xl font-bold text-white tracking-tight">Relatório Semanal com IA</h1>
        <p className="text-xs text-slate-400 mt-1">Rota: <code className="text-orange-400">/reports-weekly</code> • Papel: <span className="text-slate-300 font-semibold">Gerente</span></p>
      </div>
