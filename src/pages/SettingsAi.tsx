        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-800/80 pb-5">
          <div className="space-y-1">
            <div className="flex items-center gap-2 text-xs text-slate-400">
              ...
              <span>/</span>
              <span className="text-orange-400 font-medium">Configurações de Inteligência Artificial</span>
            </div>
            ...
            <p className="text-xs text-slate-400 max-w-2xl leading-relaxed">
              Ajuste do tom de voz, regras de atendimento no WhatsApp, sugestões de complementos e sensibilidade.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
            <div key="0" className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-all space-y-2">
              <div className="text-xs font-bold text-white flex items-center gap-1.5">
                ...
                <span>Tom de Voz no WhatsApp</span>
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">Configuração da personalidade: calorosa, ágil, formal ou descontraída com emojis.
              </p>
            </div>
            <div key="1" className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-all space-y-2">
              <div className="text-xs font-bold text-white flex items-center gap-1.5">
                ...
                <span>Sugestões de Upsell</span>
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">Regras para sugerir borda recheada, refrigerante ou sobremesa durante o pedido.
              </p>
            </div>
            <div key="2" className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-all space-y-2">
              <div className="text-xs font-bold text-white flex items-center gap-1.5">
                ...
                <span>Gatilhos de Escalonamento</span>
              </div>
              <p className="text-[11px] text-slate-400 leading-relaxed">Critérios para a IA transferir a conversa para um atendente humano imediatamente.
              </p>
            </div>
          </div>
        </div>
